...
const About = () => {
  return (
    <div className='about'>
        ...
        <h2>Nurturin Tomorrow's Leaders Today</h2>
        <p>Embark on a transformative educational journey with our 
            university's comprehensive education programs. Our 
            cutting edge curriculum is designed to empower students with the knowledge,
            skills, and experiences needed to excel in the dynamic field of
            deucation.
        </p>
        <p>Whether you aspire to become a teacher, administrator conselor ,
            or educational leader. our diverse range of programs offers the 
            perfect pathway to achieve your goals and unlock your full potenial in shaping the 
            future of education.
        </p>
        </div>
